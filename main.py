...
class Game:
    ...
    def welcome_screen(self):
        ...
        Label(self.welcome_frame, text='Pilih Mode Game',
                bg='#DCE0E1', fg='#000000',
                font=('',20)).pack(padx=10,pady=40)

        Button(self.welcome_frame, text='Lawan Komputer',
                bg='#c8fae4', fg='#000000',
                command=lambda: self.player_info_screen(1)).pack(padx=30,pady=30)
        
        Button(self.welcome_frame, text='Bersama Teman',
                bg='#c8fae4', fg='#000000',
    ...
    def player_info_screen(self,player_number):
        ...
        Label(self.player_info_frame,text='Informasi Pemain',
                bg='#DCE0E1', fg='#000000',
        ...
        for i in range(self.game_mode):
            ...
            Label(l,text=f'Pemain {i+1}',bg='#DCE0E1',fg='#000000',font=('',12)).pack(side=LEFT,padx=20)
        ...
        self.toss_bt = Button(self.player_info_frame,text='Suuuiiit!',command=lambda: self.toss(entryList))
        self.toss_bt.pack()
    ...
    def toss(self,lst):
        ...
        if self.is_p1_turn:
            ...
            Label(self.toss_frame,text=f'{self.p2.name} Menang!',
                    bg='#DCE0E1', fg='#000000',
                    font=('',10)).pack(pady=10)
            ...
            Label(self.toss_frame,text=f"{self.p2.name} Menang! Silahkan lanjutkan dengan tanda O",
                    bg='#DCE0E1', fg='#000000',
    ...
    def game_window(self):
        ...
        if self.is_p1_turn:
            self.l1.config(text= "Saatnya " + self.p1.name + " jalan!")
        else:
    ...
    def check_result(self,player):
        for i in range(3):
            ...
            if self.gb_List[i*3]['text'] == self.gb_List[i*3+1]['text'] == self.gb_List[i*3+2]['text'] == player.marker:
                ...
                self.root.after(500,lambda: self.display_massage('Selamat',f'{player.name} memenangkan permainan!'))
                self.game_over = True
        ...
        if self.count == 9 and not self.game_over:
            self.root.after(500,lambda: self.display_massage('Seri!','Alias tidak ada yang menang'))
            self.game_over = True
